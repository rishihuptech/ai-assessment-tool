                      ...
                      {r.suggestions && r.suggestions.trim() && (
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-5">
                          <div className="flex items-start gap-2">
                            ...
                            <div>
                              <h5 className="text-xs font-semibold text-blue-800 mb-1">Tool/Workflow Suggestion</h5>
                              <p className="text-xs text-blue-700 leading-relaxed">{r.suggestions}</p>
                            </div>
                          </div>
                        </div>
                      )}
